        ...
        <section  style={ {
            ...
            <div className="py-16 lg:py-18 px-4 mx-auto max-w-screen-md">
                ...
                <p className="mb-8 lg:mb-16 font-light text-center text-black sm:text-xl">Connect Anytime, Anywhere - Work with Us
                    Wherever You are..</p>
                <form onSubmit={handleSubmit} method="POST" action="https://script.google.com/macros/s/AKfycbyqUDcOWFpU5olUxiXgPQl57y-tpAoqOytGhN0QdORINqmifRLFc6xbQAcC8oAnVw/exec" className="space-y-8">
                    <div>

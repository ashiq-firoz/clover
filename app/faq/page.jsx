                ...
                <div className="grid pt-8 text-left border-t border-gray-200 md:gap-16 dark:border-gray-700 md:grid-cols-2">
                    <div>
                        <div className="mb-10">
                            ...
                            <p className="text-gray-500 dark:text-gray-400">We provide a variety of social media management solutions that are tailored to each of our clients' specific needs. The number of posts we generate and publish on your social media accounts varies per package, with options ranging from 8 to 16 posts per month, depending on your demands. Nonetheless, we constantly work with our clients to identify the best posting frequency to help them achieve their goals.</p>
                        </div>
                        <div className="mb-10">
                            <h3 className="flex items-center mb-4 text-lg font-medium text-gray-900 dark:text-white">
                                <svg className="flex-shrink-0 mr-2 w-5 h-5 text-gray-500 dark:text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-8-3a1 1 0 00-.867.5 1 1 0 11-1.731-1A3 3 0 0113 8a3.001 3.001 0 01-2 2.83V11a1 1 0 11-2 0v-1a1 1 0 011-1 1 1 0 100-2zm0 8a1 1 0 100-2 1 1 0 000 2z" clipRule="evenodd"></path></svg>
                        ...
                        <div className="mb-10">
                            ...
                            <p className="text-gray-500 dark:text-gray-400">If you have any questions or concerns, we are always happy to hear from you. You can reach out to our team by submitting an application on our website, which is the best way to get started with our services. Alternatively, you can also send us a message on Instagram and we'll get back to you as soon as possible.</p>
                    ...
                    <div>
                        ...
                        <div className="mb-10">
                            ...
                            <p className="text-gray-500 dark:text-gray-400">We work on Instagram, Facebook, TikTok and Linkedin </p>

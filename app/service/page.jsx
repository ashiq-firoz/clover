...
export default function StickyScrollRevealDemo() {
  ...
  <button className="bg-gradient-to-r from-green-400 to-green-500 hover:from-green-500 hover:to-green-600 text-white font-bold py-2 px-4 rounded-full shadow-lg flex items-center justify-center">
    <a target="blank" rel="noopener noreferrer" href="https://api.whatsapp.com/send/?phone=%2B971527074607&text=I%27m+interested+,+tell+me+more+about+your+service&type=phone_number&app_absent=0" className="flex items-center">
